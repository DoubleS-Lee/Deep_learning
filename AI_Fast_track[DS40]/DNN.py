...
def model_setting(file_name, train_input, train_label, valid_input, valid_label):
    ...
    train_sequence=model.fit(train_input, train_label, epochs=10000, batch_size=32, verbose=1, callbacks=[early_stop], shuffle=True)
    evaluate_sequence=model.evaluate(valid_input, valid_label, batch_size=32, verbose=1, callbacks=[early_stop])
   
    model_result = model.save(f'{file_name}_DNN_model.h5')
...
QT_model_as_predict = model_predict(QT_model_as, QT_as_test_input, 'QT_as_DNN_predict.xlsx')
QT_model_a_predict = model_predict(QT_model_a, QT_a_test_input, 'QT_a_DNN_predict.xlsx')
QT_model_s_predict = model_predict(QT_model_s, QT_s_test_input, 'QT_s_DNN_predict.xlsx')
...
QT_result.to_excel("QT_DNN_result.xlsx")
...
Mega_model_as_predict = model_predict(Mega_model_as, Mega_as_test_input, 'Mega_as_DNN_predict.xlsx')
Mega_model_a_predict = model_predict(Mega_model_a, Mega_a_test_input, 'Mega_a_DNN_predict.xlsx')
Mega_model_s_predict = model_predict(Mega_model_s, Mega_s_test_input, 'Mega_s_DNN_predict.xlsx')
...
Mega_result.to_excel("Mega_DNN_result.xlsx")
...
QZ_model_as_predict = model_predict(QZ_model_as, QZ_as_test_input, 'QZ_as_DNN_predict.xlsx')
QZ_model_a_predict = model_predict(QZ_model_a, QZ_a_test_input, 'QZ_a_DNN_predict.xlsx')
QZ_model_s_predict = model_predict(QZ_model_s, QZ_s_test_input, 'QZ_s_DNN_predict.xlsx')
...
QZ_result.to_excel("QZ_DNN_result.xlsx")
